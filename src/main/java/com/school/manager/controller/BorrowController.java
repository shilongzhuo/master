...
public class BorrowController {
    ...
    public JsonResult faceSign(@RequestParam String img,@RequestParam Integer equipment_id,@RequestParam String borrow_date,@RequestParam Integer subId) throws ParseException {
...
//            String faceToken = searchResult.get("face_token").toString();
            ...
            if (userId != user_id) {
                result = new JsonResult<>(ResultType.NOT_INCONF);
                return result;
            }
            ...
            //修改转借状态
            Subtenancy subtenancy = subtenancyService.queryById(subId);
            subtenancy.setStatus("同意");
